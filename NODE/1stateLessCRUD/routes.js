...
const array2 = 'http://localhost:3000/api/todos/2'.split("/")
const arrDynamicIndex = 'http://localhost:3000/api/todos/2'.split("/").length-1
const indDynamic = array2[arrDynamicIndex]